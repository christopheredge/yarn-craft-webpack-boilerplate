...
return array(
     ...
     */
        ...
        'user' => 'scale_mysql', // The database username to connect with.
        'password' => 'scale', // The database password to connect with.
        'database' => 'scale_db', // The name of the database to select.
    ),
		/**
